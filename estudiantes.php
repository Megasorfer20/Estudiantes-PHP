        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td><?= $value ['logros']?></td>
              <td>
                <a class="btn btn-danger" href="borrarEstudiante.php?id=<?=$value['id']?>&req=delete">Borrar</a>
                
                <a class="btn btn-warning" href="EditarEstudiante.php?id=<?=$value['id']?>">Editar</a>
              </td>
            </tr>
                <?php } ?>
